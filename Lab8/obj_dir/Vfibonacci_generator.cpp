...
void Vfibonacci_generator::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("fibonacci_generator.v", 2, "",
...
VL_INLINE_OPT void Vfibonacci_generator::_sequent__TOP__1(Vfibonacci_generator__Syms* __restrict vlSymsp) {
    ...
    // Body
    __Vdly__fibonacci_generator__DOT__fib_prev2 = vlTOPp->fibonacci_generator__DOT__fib_prev2;
    __Vdly__fibonacci_generator__DOT__fib_prev1 = vlTOPp->fibonacci_generator__DOT__fib_prev1;
    if (vlTOPp->rst) {
    ...
    vlTOPp->fibonacci_generator__DOT__fib_prev1 = __Vdly__fibonacci_generator__DOT__fib_prev1;
    vlTOPp->fibonacci_generator__DOT__fib_prev2 = __Vdly__fibonacci_generator__DOT__fib_prev2;
}
