module bitty_core(
	...
	alu calculate(1'b0, alu_ops1, mux_out, alu_sel, alu_mode, alu_c_out, alu_cmp, alu_res);

	control_unit ctrl(take_instr, run, clk, reset, mux_sel, alu_sel, alu_mode, 
													en_s, en_c, en_reg, en_i, done, parity);
